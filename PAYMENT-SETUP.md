...
3. Add `STREAMELEMENTS_ACCOUNT_ID` and `STREAMELEMENTS_JWT` through Supabase Edge Function Secrets. Never place the private JWT in GitHub.
...
- The signed-in status page checks for the matching successful StreamElements payment every 15 seconds.
