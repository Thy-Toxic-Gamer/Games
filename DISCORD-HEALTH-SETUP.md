...
4. Redeploy `supabase/functions/discord-game-requests/index.ts` as the existing `discord-game-requests` Edge Function. Keep its current database-webhook authentication and secrets unchanged.
